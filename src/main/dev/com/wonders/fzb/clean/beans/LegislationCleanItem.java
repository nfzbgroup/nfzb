...
/**
 * LEGISLATION_CLEAN_ITEM Bean (操作业务实体) 
 * autoCreated by liujun
 */
@SuppressWarnings("serial")
@Entity
@Table(name = "LEGISLATION_CLEAN_ITEM")
public class LegislationCleanItem implements Serializable {

  public static final String LegislationCleanItem = "LEGISLATION_CLEAN_ITEM";
	
  public LegislationCleanItem()
  {
  }
