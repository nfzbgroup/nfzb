...
/**
 * LEGISLATION_CLEAN_TASK Bean (操作业务实体) 
 * autoCreated by liujun
 */
@SuppressWarnings("serial")
@Entity
@Table(name = "LEGISLATION_CLEAN_TASK")
public class LegislationCleanTask implements Serializable {

  public static final String LegislationCleanTask = "LEGISLATION_CLEAN_TASK";
	
  public LegislationCleanTask()
  {
  }
