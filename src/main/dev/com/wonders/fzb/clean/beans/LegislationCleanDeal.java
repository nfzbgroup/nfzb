...
/**
 * LEGISLATION_CLEAN_DEAL Bean (操作业务实体) 
 * autoCreated by liujun
 */
@SuppressWarnings("serial")
@Entity
@Table(name = "LEGISLATION_CLEAN_DEAL")
public class LegislationCleanDeal implements Serializable {

  public static final String LegislationCleanDeal = "LEGISLATION_CLEAN_DEAL";
	
  public LegislationCleanDeal()
  {
  }
