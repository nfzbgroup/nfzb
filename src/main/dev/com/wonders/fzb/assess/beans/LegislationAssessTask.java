...
/**
 * LEGISLATION_ASSESS_TASK Bean (操作业务实体) 
 * autoCreated by liujun
 */
@SuppressWarnings("serial")
@Entity
@Table(name = "LEGISLATION_ASSESS_TASK")
public class LegislationAssessTask implements Serializable {

  public static final String LegislationAssessTask = "LEGISLATION_ASSESS_TASK";
	
  public LegislationAssessTask()
  {
  }
