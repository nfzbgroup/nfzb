...
/**
 * LEGISLATION_CITYMEETING_DEAL Bean (操作业务实体) 
 * autoCreated by liujun
 */
@SuppressWarnings("serial")
@Entity
@Table(name = "LEGISLATION_CITYMEETING_DEAL")
public class LegislationCitymeetingDeal implements Serializable {

  public static final String LegislationCitymeetingDeal = "LEGISLATION_CITYMEETING_DEAL";
	
  public LegislationCitymeetingDeal()
  {
  }
