...
/**
 * LEGISLATION_CITYMEETING_TASKD Bean (操作业务实体) 
 * autoCreated by liujun
 */
@SuppressWarnings("serial")
@Entity
@Table(name = "LEGISLATION_CITYMEETING_TASKD")
public class LegislationCitymeetingTaskd implements Serializable {

  public static final String LegislationCitymeetingTaskd = "LEGISLATION_CITYMEETING_TASKD";
	
  public LegislationCitymeetingTaskd()
  {
  }
