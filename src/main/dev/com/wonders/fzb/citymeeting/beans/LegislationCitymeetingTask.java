...
/**
 * LEGISLATION_CITYMEETING_TASK Bean (操作业务实体) 
 * autoCreated by liujun
 */
@SuppressWarnings("serial")
@Entity
@Table(name = "LEGISLATION_CITYMEETING_TASK")
public class LegislationCitymeetingTask implements Serializable {

  public static final String LegislationCitymeetingTask = "LEGISLATION_CITYMEETING_TASK";
	
  public LegislationCitymeetingTask()
  {
  }
	 ...
	 * DT_BAK
	 */
	public void setDtBak (Date dtBak){
		this.dtBak = dtBak;
	}
