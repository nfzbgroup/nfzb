...
/**
 * LEGISLATION_PLAN_TASKDETAIL Bean (操作业务实体) 
 * autoCreated by liujun
 */
@SuppressWarnings("serial")
@Entity
@Table(name = "LEGISLATION_PLAN_TASKDETAIL")
public class LegislationPlanTaskdetail implements Serializable {

  public static final String LegislationPlanTaskdetail = "LEGISLATION_PLAN_TASKDETAIL";
	
  public LegislationPlanTaskdetail()
  {
  }
