...
/**
 * LEGISLATION_PLAN_DEAL Bean (操作业务实体) 
 * autoCreated by liujun
 */
@SuppressWarnings("serial")
@Entity
@Table(name = "LEGISLATION_PLAN_DEAL")
public class LegislationPlanDeal implements Serializable {

  public static final String LegislationPlanDeal = "LEGISLATION_PLAN_DEAL";
	
  public LegislationPlanDeal()
  {
  }
