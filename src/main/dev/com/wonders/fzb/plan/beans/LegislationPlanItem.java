...
@Entity
@Table(name = "LEGISLATION_PLAN_ITEM")
public class LegislationPlanItem implements Serializable {

  public static final String LegislationPlanItem = "LEGISLATION_PLAN_ITEM";
	
  public LegislationPlanItem()
  {
  }
