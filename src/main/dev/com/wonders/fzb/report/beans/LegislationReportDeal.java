...
/**
 * LEGISLATION_REPORT_DEAL Bean (操作业务实体) 
 * autoCreated by liujun
 */
@SuppressWarnings("serial")
@Entity
@Table(name = "LEGISLATION_REPORT_DEAL")
public class LegislationReportDeal implements Serializable {

  public static final String LegislationReportDeal = "LEGISLATION_REPORT_DEAL";
	
  public LegislationReportDeal()
  {
  }
