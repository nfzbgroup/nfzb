...
/**
 * LEGISLATION_REPORT_TASK Bean (操作业务实体) 
 * autoCreated by liujun
 */
@SuppressWarnings("serial")
@Entity
@Table(name = "LEGISLATION_REPORT_TASK")
public class LegislationReportTask implements Serializable {

  public static final String LegislationReportTask = "LEGISLATION_REPORT_TASK";
	
  public LegislationReportTask()
  {
  }
