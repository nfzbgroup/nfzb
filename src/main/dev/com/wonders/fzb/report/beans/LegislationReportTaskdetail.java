...
/**
 * LEGISLATION_REPORT_TASKDETAIL Bean (操作业务实体) 
 * autoCreated by liujun
 */
@SuppressWarnings("serial")
@Entity
@Table(name = "LEGISLATION_REPORT_TASKDETAIL")
public class LegislationReportTaskdetail implements Serializable {

  public static final String LegislationReportTaskdetail = "LEGISLATION_REPORT_TASKDETAIL";
	
  public LegislationReportTaskdetail()
  {
  }
