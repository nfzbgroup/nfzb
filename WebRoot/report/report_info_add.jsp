...
<div class="modal-body">
	<h2 style="color: #E4243D; text-align: center; font-weight: bold; margin-bottom: 20px">签报件核稿并送OA审核</h2>
	<form id="auditReportForm" class="form-horizontal" novalidate="novalidate">
		...
		<div class="form-body">
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text" class="form-control" id="stReportName" name="stReportName" value="${legislationReport.stReportName}">
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-2 control-label">报送领导：</label>
				<div class="col-sm-9">
					<input type="text" class="form-control" id="stAddress" name="stAddress" value="${legislationReport.stAddress}">
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-2 control-label">说明：</label>
				<div class="col-sm-9">
					<input type="text" class="form-control" id="stPersons" name="stPersons" value="${legislationReport.stPersons}">
				</div>
			</div>
			<div class="form-group">
...
<script>
	...
	function saveAuditReport1(operation) {
		...
		if (param.stAddress == null || param.stAddress == "") {
			Duang.error("提示", "请输入报送OA系统的领导");
		} else {
			if (operation == 'submit') {
