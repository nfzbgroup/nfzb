...
<div class = "conteng">
	...
	<form class = "form-horizontal" action="${basePath}/legislate/assessment_up_list.do" method="post" role = "form">   
          <div class="col">
	         <div class="control-group">
                 ...
                 <div >
                    <s:select list="#{'assessmentTitle':'项目名称','assessmentUnitName':'上报单位'}" name="queryType" cssClass="input-xlarge"></s:select>
                 </div>
                 <label  class="control-label">
    ...
    <div class = "detai">
        <div class = "detai-con">
            <div id="init" class = "tab-list <s:if test='#request.flag == "EDIT"'>tab-back</s:if> " onclick="window.location.href='${basePath}/legislate/assessment_up_list.do?flag=EDIT'">编辑中</div>
            <div id="send" class = "tab-list <s:if test='#request.flag == "REPORT"'>tab-back</s:if>"  onclick="window.location.href='${basePath}/legislate/assessment_up_list.do?flag=REPORT'">已上报</div>
            <div class = "flright" onclick = "window.location.href='${basePath}/legislate/assessment_add.do'">新建</div>
        <div class = "biaodan">
