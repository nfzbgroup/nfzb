...
<div class="modal-body">
	<form id="legislationPlanForm" class="form-horizontal" novalidate="novalidate">
            ...
            <div class="form-group">
                <label class="col-sm-3 control-label">立法计划说明：</label>
                <div class="col-sm-9">
                    <input type="text" class="form-control" name="stItemName" disabled value="${iteminfo.stSource.stRemark}"/>
                </div>
            </div>
            
            <div class="form-group">
				<label class="col-sm-3 control-label">计划包含项目： </label>
				<div class="col-sm-9">
					<table class="table table-striped table-bordered table-hover text-center" data-toggle="table" data-mobile-responsive="true" data-card-view="true" data-pagination="true">
						...
						<c:forEach var="item" items="${iteminfo.stSourceitems}" varStatus="status">
							<tr class="text-center" align="center">
								<td >
										<span style="">${item.stItemName}</span>
								</td>
								<td>
										<span style="">${item.stContent}</span>
								</td>
								<td>
