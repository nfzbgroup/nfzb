...
<div class="page-bar">
	<ul class="page-breadcrumb">
		...
		<li>
			<span>发起${legislationCheckmeeting}</span>
		</li>
	</ul>
	...
	<form id="auditMeetingForm" class="form-horizontal" novalidate="novalidate">
		...
		<div class="form-body">
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text" class="form-control" readonly id="dtBeginDate" name="dtBeginDate" <fmt:formatDate value="${legislationCheckmeeting.dtBeginDate}"/>>
				</div>
			</div>
			<div class="form-group">
			...
			<div class="col-sm-10">
				<div class="form-group">
					<label class="class=" col-sm-3 control-labeltext-left">审核会议前材料 </label>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					<label class="control-label">审核会议前其他材料 </label>
					<label class="btn btn-w-m btn-success" onclick="toUploadFile(this)">点击上传 </label>
					<input type="file" id="7" name="upload" style="display: none">
				</div>
				<div class="form-group">
						...
						<tbody id="otherMaterial">
							...
							<tr class="text-center">
								...
								<td>
									...
									<a href="#">下载</a>
									&nbsp;&nbsp;
									<label style="color: red">删除</label>
								</td>
							</tr>
			...
			<div class="form-group">
				<label class="control-label">审核会议前材料 </label>
				<label class="btn btn-w-m btn-success" onclick="toUploadFile(this)">点击上传 </label>
			</div>
			<div class="form-group">
				<table class="table table-striped table-bordered table-hover" data-toggle="table" data-mobile-responsive="true" data-card-view="true" data-pagination="true">
