	...
	<form id="auditMeetingForm" class="form-horizontal" novalidate="novalidate">
		...
		<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text"  readonly="readonly" class="form-control" id="stAddress" name="stAddress" value="${legislationCitymeeting.stAddress}">
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-2 control-label">会议时间：</label>
				<div class="col-sm-9">
					<input type="text"  readonly="readonly" class="form-control" readonly id="dtBeginDate" name="dtBeginDate" value="<fmt:formatDate value="${legislationCitymeeting.dtBeginDate}"  pattern="yyyy-MM-dd"/>">
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-2 control-label">参会人员：</label>
				<div class="col-sm-9">
					<textarea class="form-control"  readonly="readonly" id="stPersons" name="stPersons">${legislationCitymeeting.stPersons}</textarea>
				</div>
			</div>
			<div class="form-group">
