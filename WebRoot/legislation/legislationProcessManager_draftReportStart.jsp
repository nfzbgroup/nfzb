...
<script>
    function saveLegislationProcessDoc(type) {
        ...
        if(param.stComent==null||param.stComent==""){
            Duang.error("提示","请输入说明");
                ...
                $.post("${requestUrl}?stNodeId=${nodeId}&method=draftReportStart&type="+type,param,function(data){
    ...
    function uploadFile(id,type,stSampleId) {
        $.ajaxFileUpload({
            url: '${basePath}/file/upload.do?stNodeId=NOD_0000000106&stSampleId='+stSampleId,
            type: 'post',
