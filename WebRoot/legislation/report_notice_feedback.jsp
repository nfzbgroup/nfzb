    ...
    <table class="table table-border table-bordered">
		<tr>
			<td class="text-right tab-left" width="300px">
				<label style="white-space: nowrap">对应签报:</label>
			</td>
			<td class="text-center">
				${legislationReportTask.stFlowId}
			</td>
		</tr>
		<tr>
	   ...
	   <c:if test="${legislationSendNotice.stNoticeStatus!='已反馈'}">
        ...
        <div class="form-group text-center">
          <c:if test="${legislationSendNotice.stNoticeStatus!='已反馈'}">
            ...
            <input type="button" class="btn btn-w-m btn-success"
                   name="btnSave"  onclick="confirmReport('${legislationReportTask.stReportId}','${nodeId}','${legislationSendNotice.stNoticeId}')"
                  value="报送"> &nbsp;&nbsp; 
          </c:if>
