	...
	<form id="legislationDemonstrationForm" class="form-horizontal"
		...
		<div class="form-body">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <select class="form-control" name="stDocId" <c:if test="${legislationProcessTask.stDocId!=null}">disabled</c:if>>
                        <c:if test="${legislationProcessDocList !=null&&fn:length(legislationProcessDocList)>0}">
                            <c:forEach items="${legislationProcessDocList}" var="doc">
                                <c:choose>
                                    <c:when test="${legislationProcessTask.stDocId!=null&&legislationProcessTask.stDocId==doc.stDocId}">
