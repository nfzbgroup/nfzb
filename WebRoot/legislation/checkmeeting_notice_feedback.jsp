    ...
    <table class="table table-border table-bordered">
		<tr>
			<td class="text-right tab-left" width="300px">
				<label style="white-space: nowrap">对应会议:</label>
			</td>
			<td class="text-center">
				${legislationCheckMeetingTask.stFlowId}
			</td>
		</tr>
		<tr>
			...
			<td class="text-center">
				${legislationCheckMeetingTask.stBakOne}
			</td>
		</tr>
		<tr>
			<td class="text-right tab-left">
			...
			<td class="text-center">
				${legislationCheckMeetingTask.stBakTwo}
			</td>
		</tr>
		<tr>
			<td class="text-right tab-left">
	   ...
	   <c:if test="${legislationSendNotice.stNoticeStatus!='已反馈'}">
        ...
        <div class="form-group text-center">
          <c:if test="${legislationSendNotice.stNoticeStatus!='已反馈'}">
            ...
            <input type="button" class="btn btn-w-m btn-success"
                   name="btnSave"  onclick="confirmReport('${legislationCheckMeetingTask.stMeetingId}','${nodeId}','${legislationSendNotice.stNoticeId}')"
                  value="报送"> &nbsp;&nbsp; 
          </c:if>
