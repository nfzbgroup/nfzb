...
<div class="modal-body">
	<h2 style="color: #E4243D; text-align: center; font-weight: bold; margin-bottom: 20px">专家论证会发起</h2>
	<form id="onlineDemonstrationForm" class="form-horizontal" novalidate="novalidate">
		...
		<div class="form-body">
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text"   readonly class="form-control"  id="dtBakDate" name="dtBakDate" value="<fmt:formatDate value="${legislationProcessTask.dtBakDate}"  pattern="yyyy-MM-dd"/>">
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-3 control-label">专家论证会地点：</label>
				<div class="col-sm-9">
					<textarea class="form-control" name="stComment1">${legislationProcessTask.stComment1}</textarea>
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-3 control-label">专家论证会人员：</label>
				<div class="col-sm-9">
					<textarea class="form-control" name="stBakTwo">${legislationProcessTask.stBakTwo}</textarea>
				</div>
			</div>
			<div class="form-group">
			 ...
			 <div class="form-group">
				<label class="control-label">专家论证会发起材料 </label>
			</div>	
