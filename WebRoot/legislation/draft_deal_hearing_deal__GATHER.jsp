...
<h2 style="color: #E4243D;text-align: center;font-weight: bold;margin-bottom: 20px">汇总整理分析</h2>
	<form id="onlineDemonstrationForm" class="form-horizontal" novalidate="novalidate">
		...
		<div class="form-body">
			...
			<div class="form-group">
				...
				<label class="col-sm-3 control-label text-left">网上报名汇总内容填写:</label>
				<div class="col-sm-9">
					<textarea id="stComment2" name="stComment2" class="form-control">${legislationProcessTaskdetail.stBak1}</textarea>
				</div>
			</div>
			<div class="form-group">
				<label class="control-label">立法听证会汇总材料 </label>
			</div>	
		<%@include file="/legislation/file/attachUpload.jsp" %>
		<div class="form-group text-center">
		 <c:if test="${legislationProcessTask.stTaskStatus=='GATHER'}">
