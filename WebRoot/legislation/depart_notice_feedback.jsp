...
<div class="page-bar">
    <ul class="page-breadcrumb">
        <li>
            <span >
            <c:choose>
            <c:when test="${nodeId=='NOD_0000000122'}">部门意见录入 ></c:when>
            <c:otherwise>部门会签录入 ></c:otherwise>
            </c:choose>
            </span>
        </li>
        <li>
...
<c:otherwise><h2 style="color: #E4243D;text-align: center;font-weight: bold;margin-bottom: 20px">部门会签反馈</h2></c:otherwise>
</c:choose>
