...
<div class="modal-body">
	...
	<div class="form-group text-center">
		<input type="button" class="btn btn-w-m btn-success" value="添加网上报名结果" id="GATHER-RETURN"
		<c:choose>
				<c:when test="${gatherReturnDisabled}">
				 disabled="disabled"
				</c:when>
				<c:otherwise>
			   onclick="openDemonstrationTaskPageWithStatus('openCheckExplainPage','${legislationProcessTask.stTaskId}','GATHER-RETURN','${legislationProcessTask.stDocId}','${legislationProcessTask.stNodeId}')"
		        </c:otherwise>
		</c:choose>
			   > &nbsp;&nbsp;
