...
<div class="modal-body">
	...
	<form id="legislationProcessDocForm" class="form-horizontal" novalidate="novalidate">
		...
		<div class="form-group text-center">
			...
			<c:choose>
				<c:when test="${legislationProcessTask.stTaskStatus==statusCodeArray[0]}">
					<input type="button" class="btn btn-w-m btn-success" id="btnSubmit" name="btnSubmit" onclick="saveLegislationProcessDoc('submit')" value="送领导">
				</c:when>
				<c:when test="${legislationProcessTask.stTaskStatus==statusCodeArray[1]}">
					<input type="button" class="btn btn-w-m btn-success" id="btnSubmit" name="btnSubmit" onclick="saveLegislationProcessDoc('submit')" value="提交意见反馈">
				</c:when>
			</c:choose>
			&nbsp;&nbsp;
